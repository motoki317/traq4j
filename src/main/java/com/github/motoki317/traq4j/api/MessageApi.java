...
public class MessageApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 204 </td><td> No Content メッセージを編集できました。 </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> Bad Request </td><td>  -  </td></tr>
     ...
     */
    public void editMessage(UUID messageId, PostMessageRequest postMessageRequest) throws ApiException {
     ...
     */
    public ApiResponse<Void> editMessageWithHttpInfo(UUID messageId, PostMessageRequest postMessageRequest) throws ApiException {
     ...
     */
    public okhttp3.Call editMessageAsync(UUID messageId, PostMessageRequest postMessageRequest, final ApiCallback<Void> _callback) throws ApiException {
    ...
    public ApiResponse<List<MessageClip>> getMessageClipsWithHttpInfo(UUID messageId) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<List<MessageClip>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public ApiResponse<MessageSearchResult> searchMessagesWithHttpInfo(String word, OffsetDateTime after, OffsetDateTime before, UUID in, UUID to, UUID from, UUID citation, Boolean bot, Boolean hasURL, Boolean hasAttachments, Boolean hasImage, Boolean hasVideo, Boolean hasAudio, Integer limit, Integer offset, String sort) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<MessageSearchResult>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
