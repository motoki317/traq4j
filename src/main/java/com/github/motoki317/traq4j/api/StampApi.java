...
public class StampApi {
     ...
     * @param stampId スタンプUUID (required)
     * @param _file スタンプ画像(1MBまでのpng, jpeg, gif) (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call changeStampImageCall(UUID stampId, File _file, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call changeStampImageValidateBeforeCall(UUID stampId, File _file, final ApiCallback _callback) throws ApiException {
        ...
        if (_file == null) {
            throw new ApiException("Missing the required parameter '_file' when calling changeStampImage(Async)");
        }
        

        okhttp3.Call localVarCall = changeStampImageCall(stampId, _file, _callback);
        return localVarCall;
     ...
     */
    public void changeStampImage(UUID stampId, File _file) throws ApiException {
        changeStampImageWithHttpInfo(stampId, _file);
    }
     ...
     */
    public ApiResponse<Void> changeStampImageWithHttpInfo(UUID stampId, File _file) throws ApiException {
        okhttp3.Call localVarCall = changeStampImageValidateBeforeCall(stampId, _file, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call changeStampImageAsync(UUID stampId, File _file, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = changeStampImageValidateBeforeCall(stampId, _file, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     ...
     */
    public okhttp3.Call createStampCall(String name, File _file, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call createStampValidateBeforeCall(String name, File _file, final ApiCallback _callback) throws ApiException {
        ...
        // verify the required parameter '_file' is set
        if (_file == null) {
            throw new ApiException("Missing the required parameter '_file' when calling createStamp(Async)");
        }
        

        okhttp3.Call localVarCall = createStampCall(name, _file, _callback);
        return localVarCall;
     ...
     */
    public Stamp createStamp(String name, File _file) throws ApiException {
        ApiResponse<Stamp> localVarResp = createStampWithHttpInfo(name, _file);
     ...
     */
    public ApiResponse<Stamp> createStampWithHttpInfo(String name, File _file) throws ApiException {
        okhttp3.Call localVarCall = createStampValidateBeforeCall(name, _file, null);
        Type localVarReturnType = new TypeToken<Stamp>(){}.getType();
     ...
     */
    public okhttp3.Call createStampAsync(String name, File _file, final ApiCallback<Stamp> _callback) throws ApiException {

        okhttp3.Call localVarCall = createStampValidateBeforeCall(name, _file, _callback);
        Type localVarReturnType = new TypeToken<Stamp>(){}.getType();
    ...
    public ApiResponse<StampPalette> createStampPaletteWithHttpInfo(PostStampPaletteRequest postStampPaletteRequest) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<StampPalette>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public ApiResponse<List<MessageStamp>> getMessageStampsWithHttpInfo(UUID messageId) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<List<MessageStamp>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public ApiResponse<List<StampPalette>> getStampPalettesWithHttpInfo() throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<List<StampPalette>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> OK </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Not Found スタンプが見つかりません。 </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getStampStatsCall(UUID stampId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/stamps/{stampId}/stats"
            .replaceAll("\\{" + "stampId" + "\\}", localVarApiClient.escapeString(stampId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getStampStatsValidateBeforeCall(UUID stampId, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'stampId' is set
        if (stampId == null) {
            throw new ApiException("Missing the required parameter 'stampId' when calling getStampStats(Async)");
        }
        

        okhttp3.Call localVarCall = getStampStatsCall(stampId, _callback);
        return localVarCall;
     ...
     */
    public StampStats getStampStats(UUID stampId) throws ApiException {
        ApiResponse<StampStats> localVarResp = getStampStatsWithHttpInfo(stampId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<StampStats> getStampStatsWithHttpInfo(UUID stampId) throws ApiException {
        okhttp3.Call localVarCall = getStampStatsValidateBeforeCall(stampId, null);
        Type localVarReturnType = new TypeToken<StampStats>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * スタンプ統計情報を取得 (asynchronously)
     * 指定したスタンプの統計情報を取得します。
     * @param stampId スタンプUUID (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getStampStatsAsync(UUID stampId, final ApiCallback<StampStats> _callback) throws ApiException {

        okhttp3.Call localVarCall = getStampStatsValidateBeforeCall(stampId, _callback);
        Type localVarReturnType = new TypeToken<StampStats>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call getStampsCall(Boolean includeUnicode, String type, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getStampsValidateBeforeCall(Boolean includeUnicode, String type, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getStampsCall(includeUnicode, type, _callback);
        return localVarCall;
     ...
     */
    public List<Stamp> getStamps(Boolean includeUnicode, String type) throws ApiException {
        ApiResponse<List<Stamp>> localVarResp = getStampsWithHttpInfo(includeUnicode, type);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<Stamp>> getStampsWithHttpInfo(Boolean includeUnicode, String type) throws ApiException {
        okhttp3.Call localVarCall = getStampsValidateBeforeCall(includeUnicode, type, null);
        Type localVarReturnType = new TypeToken<List<Stamp>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getStampsAsync(Boolean includeUnicode, String type, final ApiCallback<List<Stamp>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getStampsValidateBeforeCall(includeUnicode, type, _callback);
        Type localVarReturnType = new TypeToken<List<Stamp>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
