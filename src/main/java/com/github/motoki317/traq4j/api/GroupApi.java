...
public class GroupApi {
    ...
    /**
     * Build call for changeUserGroupIcon
     * @param groupId ユーザーグループUUID (required)
     ...
     */
    public okhttp3.Call changeUserGroupIconCall(UUID groupId, File _file, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call changeUserGroupIconValidateBeforeCall(UUID groupId, File _file, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'groupId' is set
        if (groupId == null) {
            throw new ApiException("Missing the required parameter 'groupId' when calling changeUserGroupIcon(Async)");
        }
        
        // verify the required parameter '_file' is set
        if (_file == null) {
            throw new ApiException("Missing the required parameter '_file' when calling changeUserGroupIcon(Async)");
        }
        

        okhttp3.Call localVarCall = changeUserGroupIconCall(groupId, _file, _callback);
        return localVarCall;
     ...
     */
    public void changeUserGroupIcon(UUID groupId, File _file) throws ApiException {
        changeUserGroupIconWithHttpInfo(groupId, _file);
    }
     ...
     */
    public ApiResponse<Void> changeUserGroupIconWithHttpInfo(UUID groupId, File _file) throws ApiException {
        okhttp3.Call localVarCall = changeUserGroupIconValidateBeforeCall(groupId, _file, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * ユーザーグループのアイコンを変更 (asynchronously)
     * ユーザーグループのアイコンを変更します。 対象のユーザーグループの管理者権限が必要です。
     * @param groupId ユーザーグループUUID (required)
     * @param _file アイコン画像(1MBまでのpng, jpeg, gif) (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call changeUserGroupIconAsync(UUID groupId, File _file, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = changeUserGroupIconValidateBeforeCall(groupId, _file, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
    ...
    public ApiResponse<List<UserGroupMember>> getUserGroupMembersWithHttpInfo(UUID groupId) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<List<UserGroupMember>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
