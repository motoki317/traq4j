 ...
 * ユーザー権限
 */
@JsonAdapter(UserPermission.Adapter.class)
public enum UserPermission {
  ...
  public static UserPermission fromValue(String value) {
  ...
  public static class Adapter extends TypeAdapter<UserPermission> {
    @Override
    public void write(final JsonWriter jsonWriter, final UserPermission enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public UserPermission read(final JsonReader jsonReader) throws IOException {
