...
public class FileApi {
    ...
    public ApiResponse<List<FileInfo>> getFilesWithHttpInfo(UUID channelId, Integer limit, Integer offset, OffsetDateTime since, OffsetDateTime until, Boolean inclusive, String order, Boolean mine) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<List<FileInfo>>() {
        }.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     *
     * @param fileId    ファイルUUID (required)
     * @param type      取得するサムネイルのタイプ (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details <table summary="Response Details" border="1">
     ...
     * </table>
     */
    public okhttp3.Call postFileCall(File file, String channelId, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call postFileValidateBeforeCall(File file, String channelId, final ApiCallback _callback) throws ApiException {
     ...
     * </table>
     */
    public FileInfo postFile(File file, String channelId) throws ApiException {
     ...
     * </table>
     */
    public ApiResponse<FileInfo> postFileWithHttpInfo(File file, String channelId) throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call postFileAsync(File file, String channelId, final ApiCallback<FileInfo> _callback) throws ApiException {
