...
public class WebhookApi {
     ...
     */
    public okhttp3.Call changeWebhookIconCall(UUID webhookId, File file, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call changeWebhookIconValidateBeforeCall(UUID webhookId, File file, final ApiCallback _callback) throws ApiException {
        ...
        if (file == null) {
            throw new ApiException("Missing the required parameter 'file' when calling changeWebhookIcon(Async)");
        }
        

        okhttp3.Call localVarCall = changeWebhookIconCall(webhookId, file, _callback);
        return localVarCall;
     ...
     */
    public void changeWebhookIcon(UUID webhookId, File file) throws ApiException {
     ...
     */
    public ApiResponse<Void> changeWebhookIconWithHttpInfo(UUID webhookId, File file) throws ApiException {
        okhttp3.Call localVarCall = changeWebhookIconValidateBeforeCall(webhookId, file, null);
     ...
     */
    public okhttp3.Call changeWebhookIconAsync(UUID webhookId, File file, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = changeWebhookIconValidateBeforeCall(webhookId, file, _callback);
     ...
     */
    public Webhook editWebhook(UUID webhookId, PatchWebhookRequest patchWebhookRequest) throws ApiException {
        ApiResponse<Webhook> localVarResp = editWebhookWithHttpInfo(webhookId, patchWebhookRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Webhook> editWebhookWithHttpInfo(UUID webhookId, PatchWebhookRequest patchWebhookRequest) throws ApiException {
     ...
     */
    public okhttp3.Call editWebhookAsync(UUID webhookId, PatchWebhookRequest patchWebhookRequest, final ApiCallback<Webhook> _callback) throws ApiException {
     ...
     * @param embed メンション・チャンネルリンクを自動埋め込みする場合に1を指定する (optional)
     * @param body  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
