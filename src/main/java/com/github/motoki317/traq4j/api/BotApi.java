...
public class BotApi {
     ...
     * </table>
     */
    public okhttp3.Call changeBotIconCall(UUID botId, File file, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call changeBotIconValidateBeforeCall(UUID botId, File file, final ApiCallback _callback) throws ApiException {
        ...
        if (file == null) {
            throw new ApiException("Missing the required parameter 'file' when calling changeBotIcon(Async)");
        }


        okhttp3.Call localVarCall = changeBotIconCall(botId, file, _callback);
        return localVarCall;
     ...
     * </table>
     */
    public void changeBotIcon(UUID botId, File file) throws ApiException {
     ...
     * </table>
     */
    public ApiResponse<Void> changeBotIconWithHttpInfo(UUID botId, File file) throws ApiException {
        okhttp3.Call localVarCall = changeBotIconValidateBeforeCall(botId, file, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     * </table>
     */
    public okhttp3.Call changeBotIconAsync(UUID botId, File file, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = changeBotIconValidateBeforeCall(botId, file, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    ...
    public ApiResponse<BotDetail> createBotWithHttpInfo(PostBotRequest postBotRequest) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<BotDetail>() {
        }.getType();
     ...
     * </table>
     */
    public Object getBot(UUID botId, Boolean detail) throws ApiException {
        ApiResponse<Object> localVarResp = getBotWithHttpInfo(botId, detail);
        return localVarResp.getData();
    }
     ...
     * </table>
     */
    public ApiResponse<Object> getBotWithHttpInfo(UUID botId, Boolean detail) throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call getBotAsync(UUID botId, Boolean detail, final ApiCallback<Object> _callback) throws ApiException {
    ...
    public ApiResponse<List<BotEventLog>> getBotLogsWithHttpInfo(UUID botId, Integer limit, Integer offset) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<List<BotEventLog>>() {
        }.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public ApiResponse<List<Bot>> getBotsWithHttpInfo(Boolean all) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<List<Bot>>() {
        }.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public ApiResponse<BotTokens> reissueBotWithHttpInfo(UUID botId) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<BotTokens>() {
        }.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
