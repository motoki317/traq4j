...
public class MeApi {
    ...
    public ApiResponse<UserTag> addMyUserTagWithHttpInfo(PostUserTagRequest postUserTagRequest) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<UserTag>() {
        }.getType();
     ...
     * </table>
     */
    public okhttp3.Call changeMyIconCall(File file, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call changeMyIconValidateBeforeCall(File file, final ApiCallback _callback) throws ApiException {

        // verify the required parameter 'file' is set
        if (file == null) {
            throw new ApiException("Missing the required parameter 'file' when calling changeMyIcon(Async)");
        }


        okhttp3.Call localVarCall = changeMyIconCall(file, _callback);
        return localVarCall;
     ...
     * </table>
     */
    public void changeMyIcon(File file) throws ApiException {
     ...
     * </table>
     */
    public ApiResponse<Void> changeMyIconWithHttpInfo(File file) throws ApiException {
        okhttp3.Call localVarCall = changeMyIconValidateBeforeCall(file, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     * </table>
     */
    public okhttp3.Call changeMyIconAsync(File file, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = changeMyIconValidateBeforeCall(file, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
     ...
     * <tr><td> 400 </td><td> 指定したURLが不正です </td><td>  -  </td></tr>
     * <tr><td> 404 </td><td> 指定したURLに対するユーザー設定情報が見つかりませんでした。 </td><td>  -  </td></tr>
     * </table>
     */
    ...
    public ApiResponse<MyUserDetail> getMeWithHttpInfo() throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<MyUserDetail>() {
        }.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public ApiResponse<List<UserSubscribeState>> getMyChannelSubscriptionsWithHttpInfo() throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<List<UserSubscribeState>>() {
        }.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public ApiResponse<GetNotifyCitation> getMyNotifyCitationWithHttpInfo() throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<GetNotifyCitation>() {
        }.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public ApiResponse<List<ActiveOAuth2Token>> getMyTokensWithHttpInfo() throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<List<ActiveOAuth2Token>>() {
        }.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public ApiResponse<List<UnreadChannel>> getMyUnreadChannelsWithHttpInfo() throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<List<UnreadChannel>>() {
        }.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public ApiResponse<List<UserTag>> getMyUserTagsWithHttpInfo() throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<List<UserTag>>() {
        }.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public ApiResponse<List<MyChannelViewState>> getMyViewStatesWithHttpInfo() throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<List<MyChannelViewState>>() {
        }.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public ApiResponse<UserSettings> getUserSettingsWithHttpInfo() throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<UserSettings>() {
        }.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
