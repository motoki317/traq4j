...
public class UserApi {
     ...
     */
    public okhttp3.Call changeUserIconCall(UUID userId, File file, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call changeUserIconValidateBeforeCall(UUID userId, File file, final ApiCallback _callback) throws ApiException {
        ...
        if (file == null) {
            throw new ApiException("Missing the required parameter 'file' when calling changeUserIcon(Async)");
        }
        

        okhttp3.Call localVarCall = changeUserIconCall(userId, file, _callback);
        return localVarCall;
     ...
     */
    public void changeUserIcon(UUID userId, File file) throws ApiException {
     ...
     */
    public ApiResponse<Void> changeUserIconWithHttpInfo(UUID userId, File file) throws ApiException {
        okhttp3.Call localVarCall = changeUserIconValidateBeforeCall(userId, file, null);
     ...
     */
    public okhttp3.Call changeUserIconAsync(UUID userId, File file, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = changeUserIconValidateBeforeCall(userId, file, _callback);
     ...
     * @param since 取得する時間範囲の開始日時 (optional, default to OffsetDateTime.parse(&quot;0000-01-01T00:00Z[GMT]&quot;, java.time.format.DateTimeFormatter.ISO_ZONED_DATE_TIME.withZone(java.time.ZoneId.systemDefault())))
     ...
     * @param includeSuspended アカウントがアクティブでないユーザーを含めるかどうか (optional, default to false)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call getUsersCall(Boolean includeSuspended, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getUsersValidateBeforeCall(Boolean includeSuspended, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getUsersCall(includeSuspended, _callback);
        return localVarCall;
     ...
     */
    public List<User> getUsers(Boolean includeSuspended) throws ApiException {
        ApiResponse<List<User>> localVarResp = getUsersWithHttpInfo(includeSuspended);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<User>> getUsersWithHttpInfo(Boolean includeSuspended) throws ApiException {
        okhttp3.Call localVarCall = getUsersValidateBeforeCall(includeSuspended, null);
     ...
     */
    public okhttp3.Call getUsersAsync(Boolean includeSuspended, final ApiCallback<List<User>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getUsersValidateBeforeCall(includeSuspended, _callback);
        Type localVarReturnType = new TypeToken<List<User>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
