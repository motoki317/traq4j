...
import com.github.motoki317.traq4j.auth.HttpBearerAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://q.trap.jp/api/v3";
    ...
    public ApiClient() {
        ...
        authentications.put("cookieAuth", new ApiKeyAuth("cookie", "r_session"));
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "/api/v3/oauth2/token";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://q.trap.jp/api/v3
     ...
     * @return a {@link com.github.motoki317.traq4j.ApiClient} object
     */
     ...
     * @throws com.github.motoki317.traq4j.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws com.github.motoki317.traq4j.ApiException If fail to serialize the given object
     */
     ...
     * @throws com.github.motoki317.traq4j.ApiException If fail to read file content from response and write to disk
     ...
     * @throws com.github.motoki317.traq4j.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws com.github.motoki317.traq4j.ApiException If the response has an unsuccessful status code or
     ...
     * @throws com.github.motoki317.traq4j.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws com.github.motoki317.traq4j.ApiException If fails to update the parameters
     */
     ...
     * @throws com.github.motoki317.traq4j.ApiException If fail to serialize the request body object into a string
     */
